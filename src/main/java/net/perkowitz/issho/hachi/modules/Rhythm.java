...
//
//import static net.perkowitz.issho.hachi.modules.RhythmInterface.ValueMode.FILL_PERCENT;
//import static net.perkowitz.issho.hachi.modules.RhythmInterface.ValueMode.TEMPO;
//import static net.perkowitz.issho.hachi.modules.RhythmInterface.ValueMode.VELOCITY;
//
//
///**
...
//    /***** constructor *********************************************************************/
//
//    public Rhythm(RhythmController controller, RhythmDisplay display, Transmitter inputTransmitter, Receiver outputReceiver) throws Exception {
//
...
//            valueMode = VELOCITY;
//            display.displayValue(step.getVelocity(), VELOCITY_MIN, VELOCITY_MAX, VELOCITY);
...
//                display.displayValue(velocity, VELOCITY_MIN, VELOCITY_MAX, VELOCITY);
//            }
//
